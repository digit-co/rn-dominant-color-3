...
public struct UIImageColors {
    ...
    public init(background: UIColor, primary: UIColor, secondary: UIColor, detail: UIColor) {
      ...
      self.detail = detail
      self.primaryHex = primary.hexString
      self.secondaryHex = secondary.hexString
      self.backgroundHex = background.hexString
      self.detailHex = detail.hexString
    }
}
...
extension UIImage {
    ...
    public func getColors(quality: UIImageColorsQuality = .lowest, _ completion: @escaping (UIImageColors?) -> Void) {
    ...
    public func getColors(quality: UIImageColorsQuality = .lowest) -> UIImageColors? {
